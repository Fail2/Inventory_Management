        ...
        if user_type == 'buyer':
            try:
                ...
                if check_password(password, buyer.password):  # Check if the password matches
                    ...
                    # If there is a 'next' parameter, redirect to it; otherwise, go to buyer_home
                    next_url = request.GET.get('next', 'buyer_home')  # Default to buyer_home if no 'next' parameter
            ...
            try:
                ...
                if check_password(password, supplier.password):  # Check if the password matches
                    ...
                    # Directly redirect to supplier_home after successful login
