        ...
        if user_type == 'buyer':
            try:
                ...
                if check_password(password, buyer.password):  # Check if the password matches
                    ...
                    # Redirect to the page that user originally tried to access or the buyer home page
                    next_page = request.GET.get('next', 'buyer_home')  # Default to 'buyer_home' if no next parameter
                    return redirect(next_page)  # Redirect to the requested next page or home page
                else:
            ...
            try:
                ...
                if check_password(password, supplier.password):  # Check if the password matches
                    ...
                    next_page = request.GET.get('next', 'supplier_home')  # Default to 'supplier_home'
