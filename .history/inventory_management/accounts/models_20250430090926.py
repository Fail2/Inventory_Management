...
class Product(models.Model):
    ...
    def delete_old_picture(self):
        ...
        if self.pk and self.picture:
            try:
                old_picture = Product.objects.get(pk=self.pk).picture
    ...
    def save(self, *args, **kwargs):
        """Override save to delete the old image before saving the new one."""
        self.delete_old_picture()  # Delete old picture before saving the new one
        super(Product, self).save(*args, **kwargs)  # Save the new product
